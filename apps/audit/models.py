...
class AuditLog(models.Model):
    ...
    class EventType(models.TextChoices):
        ...
        RESPONSE_CREATED = "request_response_created", "Добавление ответа на заявку"
        RESPONSE_UPDATED = "request_response_updated", "Изменение ответа на заявку"
        RESPONSE_DELETED = "request_response_deleted", "Удаление ответа на заявку"
