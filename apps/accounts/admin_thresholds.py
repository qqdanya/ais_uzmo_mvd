...
THRESHOLD_LABELS = {
    "request_stale_workdays": "Зависшие заявки, рабочих дней",
...
THRESHOLD_HINTS = {
    "request_stale_workdays": "Заявки в работе дольше этого срока попадают в блок зависших.",
    "asset_stale_days": "Актуальные сведения материальной базы старше этого срока помечаются как давно не обновлявшиеся.",
}
